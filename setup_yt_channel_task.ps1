# YouTube Channel Stats - X Post Task Scheduler Setup
# Run this script as Administrator to create the scheduled task
# Places the task under "OPM Insights" folder in Task Scheduler

$taskFolder = "OPM Insights"
$taskName = "SB19 YouTube Channel Post"
$taskPath = "D:\dev\sb19\run_yt_channel_post.bat"
$description = "Posts SB19 YouTube channel stats (subscribers, views, audience, MV views) to X daily at 6:30 AM"
...
# Create the trigger (daily at 6:30 AM)
...
Write-Host "Schedule: Daily at 6:30 AM"
